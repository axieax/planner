...
desn2000 = Course('DESN2000', [2], 'ENGG100 and ELEC2141 and (COMP1511 or 1521)')
...
''' ELEC '''
elec1111 = Course('ELEC1111', [0, 1, 3], '', 6)
elec2133 = Course('ELEC2133', [0,2], 'Co-requisite: ELEC2134')
elec2134 = Course("ELEC2134", [1,3], "Co-requisite: ELEC1111")
elec2141 = Course("ELEC2141", [1], "Co-requisite: ELEC1111")

''' PHYS'''
phys1131 = Course('PHYS1231', [1,2,3],'' ,6)
phys1231 = Course('PHYS1231', [1,3], 'PHYS1131', 6)
